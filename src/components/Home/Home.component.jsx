...
const Home=()=>{
    ...
    <>
      ...
      <div className="w-full h-full">
          ...
          <div className="mx-1/2 absolute w-48 h-48 rounded-full md:w-60 md:h-60 lg:w-96 lg:h-96 top-32 left-16">
              <img src={profile}
               alt="profilepic"
               className="w-full h-full rounded-full object-cover m-auto" />
          </div>
      </div>
      <div className="absolute z-10 text-center font-bold bottom-12 px-2 md:bottom-32 lg:px-8 lg:right-0">
          <h1 className="text-2xl text-white leading-loose md:text-5xl">Hello! <br/>I'm Gayathri<br/>Full Stack Web Developer</h1>
      </div>
      </div>
